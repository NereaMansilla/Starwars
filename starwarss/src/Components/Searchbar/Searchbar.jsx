...
const {data} = useGetCharactersQuery()
  ...
  return (
    <div className=' absolute w-[100%] flex flex-col justify-center items-center mt-[1%] sm:mt-[3%] lg:mt-[1.5%]'>
     
        <form onSubmit={SendInfo}  className=" w-full flex justify-center  items-center   ">
        <input  autoComplete='true' defaultValue={search} onChange={(e)=> setSearch(e.target.value)} className=" relative w-[50vw] z-[999] h-[4vh] bg-[#ffffff3f] md:w-[40vw] lg:w-[30vw]" type="text" placeholder='may the force be with you...' /> 
      </form>


    <div className='z-[200] bg-[#585858] w-[50vw] max-h-[10vh] overflow-y-auto md:w-[40vw] lg:w-[20vw]'  id='scrollbar'>
      {
        data?.filter((c)=>{
